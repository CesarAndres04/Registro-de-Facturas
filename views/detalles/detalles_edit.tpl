...
<body onload="actualizarValorUnitario()">
  ...
  <form action="/detalles/save" method="post">
    ...
    <table>
      ...
      <tr>
        <td>Cantidad:</td>
        <td><input type="number" id="cantidad" name="cantidad" onChange="actualizarValorTotal()" value="{{detalles_data[1]}}"></td>
      </tr>
      <tr>
        <td>Servicio:</td>
        <td>
      ...
      <tr>
        ...
        <td><input type="number" id="valor_unitario" name="valor_unitario" step=0.01 onChange="actualizarValorTotal()" value="0"></td>
      </tr>
      <tr>
        <td>Total:</td>
